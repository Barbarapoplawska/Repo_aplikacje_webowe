...
PLCIE = models.IntegerChoices('Plec','Kobieta Męczyzna Inne')
...
class Person(models.Model):
    ...
    def __str__(self):
        return f"Person : {self.name},pseudonim :{self.pseudonim}, dodana w {self.month_added}, o rozmiarze koszuli {self.shirt_size}." 
...
class Osoba(models.Model):
    ...
    plec = models.IntegerField(choices=PLCIE, default=PLEC_CHOICES[2][0])
